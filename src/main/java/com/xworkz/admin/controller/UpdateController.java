...
public class UpdateController {
    ...
    public String showreglist(@RequestParam(required = false) String search, Model model) {
        List<RegistrationEntity> registrationEntityList = adminService.findFilteredRegistration(search);
        model.addAttribute("registrationentityforupdate", registrationEntityList);
        return "update";
    }
